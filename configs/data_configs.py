...
DATASETS = {
    ...
    'vox_encode':{
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['vox_train'],
		'train_target_root': dataset_paths['vox_train'],
		'test_source_root': dataset_paths['vox_test'],
		'test_target_root': dataset_paths['vox_test'],
	},
	'celebvhq_encode': {
		'transforms': transforms_config.EncodeTransforms,
		'train_source_root': dataset_paths['celebvhq_train'],
		'train_target_root': dataset_paths['celebvhq_train'],
		'test_source_root': dataset_paths['celebvhq_test'],
		'test_target_root': dataset_paths['celebvhq_test'],
	},
}
