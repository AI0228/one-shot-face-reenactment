dataset_paths = {
	...
	# vox Dataset
    'vox_train': '/root/autodl-tmp/encoder4editing-main/Vox',
    'vox_test': '/root/autodl-tmp/encoder4editing-main/Vox_test',

	#CelebV-HQ
	'celebvhq_train': '/root/autodl-tmp/new_celebvhq/train',
	'celebvhq_test': '/root/autodl-tmp/new_celebvhq/test',
}
...
model_paths = {
	...
	'face_parsing': 'pretrained_models/faceParsing_79999_iter.pth'
}
