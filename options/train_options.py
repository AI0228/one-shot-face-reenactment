...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--encoder_type', default='HibridEncoder', type=str, help='Which encoder to use')
        ...
        self.parser.add_argument('--gradient_variance_lambda', default=0, type=float,
                                 help='Gradient variance loss multiplier factor')
        self.parser.add_argument('--id_lambda', default=0.1, type=float, help='ID loss multiplier factor')
        self.parser.add_argument('--id_latent_lambda', default=0, type=float, help='ID latent loss multiplier factor')
        self.parser.add_argument('--s_lambda', default=1, type=float,
                                 help='Regularization loss S latent ratio multiplier factor')
        self.parser.add_argument('--regularization_lambda', default=0, type=float,
                                 help='Regularization loss multiplier factor')
        self.parser.add_argument('--feature_reconstruction_lambda', default=0, type=float,
                                 help='Feature reconstruction loss multiplier factor')
